...
### Step 1: Install Jan[](https://jan.ai/docs/quickstart#step-1-install-jan)
...
*   [Desktop](https://jan.ai/docs/desktop)
*   [Server](https://jan.ai/docs/server)
...
### Step 2: Turn on the GPU Acceleration (Optional)[](https://jan.ai/docs/quickstart#step-2-turn-on-the-gpu-acceleration-optional)
...
Ensure you have installed your GPU driver. Please see [Desktop](https://jan.ai/docs/desktop) for more information on activating the GPU acceleration.

  

![Turn on GPU acceleration](https://jan.ai/_next/static/media/gpu2.b790c4ae.gif)

### Step 3: Download a Model[](https://jan.ai/docs/quickstart#step-3-download-a-model)
...
8.  Adjust the configurations as needed.
    ...
    Please see [Model Parameters](https://jan.ai/docs/models#model-parameters) for detailed model configuration.
...
### Step 4: Customize the Assistant Instruction[](https://jan.ai/docs/quickstart#step-4-customize-the-assistant-instruction)
...
### Step 5: Start Thread[](https://jan.ai/docs/quickstart#step-5-start-thread)
...
### Step 6: Connect to a Remote API[](https://jan.ai/docs/quickstart#step-6-connect-to-a-remote-api)
...
## What's Next?[](https://jan.ai/docs/quickstart#whats-next)

Now that Jan is up and running, explore further:

1.  Learn how to download and manage your [models](https://jan.ai/docs/models).
2.  Customize Jan's [application settings](https://jan.ai/docs/settings) according to your preferences.
3.  Discover supported [integrations](https://jan.ai/integrations) to expand Jan's capabilities.
4.  Find out how to use [Jan as a client and a server](https://jan.ai/docs/local-api).