...
### 2\. Hardware Setup Errors[](#2-hardware-setup-errors)
...
### 5\. Advanced Settings Errors[](#5-advanced-settings-errors)

These errors relate to advanced settings and configurations within the application.

*   **Prefix**: ADV

### 6\. Inference Engine Errors[](#6-inference-engine-errors)
...
### 7\. Local API Server Errors[](#7-local-api-server-errors)

These errors relate to the local API server's functionality.

*   **Prefix**: API

#### Error Types[](#error-types-3)
...
### 9\. Troubleshooting Errors[](#9-troubleshooting-errors)

These errors occur during the troubleshooting processes and procedures.

*   **Prefix**: TRO

### 10\. Unclear Errors[](#10-unclear-errors)
